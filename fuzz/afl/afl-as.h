...
/*
 * [jfmcoronel]
 * Olivine additions for 64-bit (32-bit not supported):
 * • __olivine_area_ptr : __afl_area_ptr
 * • OLIVINE_SHM_ENV : AFL_SHM_ENV
 * • OLIVINE_SHM_ENV_VAR : SHM_ENV_VAR
 * • __olivine_global_area_ptr : __afl_global_area_ptr
 */

#include "olivine.h"
// Both registers are assumed to be callee-saved
#define OLIVINE_SHM_REGISTER "%r15"
#define OLIVINE_TEMP_REGISTER "%r14"
...
static const u8* main_payload_64 = 
  ...
  "  /* Check if SHM region is already mapped. */\n"
  "\n"
  "  movq  __afl_area_ptr(%rip), %rdx\n"  // [jfmcoronel] Analog below
  "  testq %rdx, %rdx\n"
  "  je    __afl_setup\n"
#ifdef OLIVINE_COMMON
  "  /* Check if Olivine SHM region is already mapped; store in OLIVINE_SHM_REGISTER. */\n"
  "\n"
  "  movq  __olivine_area_ptr(%rip), " OLIVINE_SHM_REGISTER "\n"
  "  testq " OLIVINE_SHM_REGISTER ", " OLIVINE_SHM_REGISTER "\n"
  "  je    __afl_setup\n"
...
#ifdef OLIVINE_COMMON
  "  /* Check out if we have a global pointer for Olivine on file. */\n"
  "\n"
#ifndef __APPLE__
  "  movq  __olivine_global_area_ptr@GOTPCREL(%rip), " OLIVINE_SHM_REGISTER "\n"
  "  movq  (" OLIVINE_SHM_REGISTER "), " OLIVINE_SHM_REGISTER "\n"
#else
  "  movq  __olivine_global_area_ptr(%rip), " OLIVINE_SHM_REGISTER "\n"
#endif /* !^__APPLE__ */
  "  testq " OLIVINE_SHM_REGISTER ", " OLIVINE_SHM_REGISTER "\n"
  "  je    __afl_setup_first\n"
  "\n"
  "  movq " OLIVINE_SHM_REGISTER ", __olivine_area_ptr(%rip)\n"
#endif // OLIVINE_COMMON
  "  jmp  __afl_store\n" 
  "\n"
  "__afl_setup_first:\n"
  ...
  "  movq %r10,  56(%rsp)\n"
  "  movq %r11,  64(%rsp)\n"
  // [jfmcoronel] OLIVINE_SHM_REGISTER and OLIVINE_TEMP_REGISTER are assumed to be callee-saved
  "\n"
  "  movq %xmm0,  96(%rsp)\n"
  "  movq %xmm1,  112(%rsp)\n"
  "  movq %xmm2,  128(%rsp)\n"
...
#ifdef OLIVINE_COMMON
  // [jfmcoronel]
  // Duplicate entire process of getting environment variable
  // Do not save registers anymore
  // Save rdx in OLIVINE_TEMP_REGISTER and restore before continuing
  "  movq  %rdx, " OLIVINE_TEMP_REGISTER "\n"
  "  /* Map SHM, jumping to __afl_setup_abort if something goes wrong. */\n"
  "\n"
  //"  /* The 64-bit ABI requires 16-byte stack alignment. We'll keep the\n"
  //"     original stack ptr in the callee-saved r12. */\n"
  ...
  "  /* Store the address of the SHM region. */\n"
  "\n"
  "  movq %rax, " OLIVINE_SHM_REGISTER "\n"
  "  movq %rax, __olivine_area_ptr(%rip)\n"
  "\n"
#ifdef __APPLE__
  "  movq %rax, __olivine_global_area_ptr(%rip)\n"
#else
  "  movq __olivine_global_area_ptr@GOTPCREL(%rip), " OLIVINE_SHM_REGISTER "\n"
  "  movq %rax, (" OLIVINE_SHM_REGISTER ")\n"
#endif /* ^__APPLE__ */
  "  movq %rax, " OLIVINE_SHM_REGISTER "\n"
  "\n"
  // Restore rdx from OLIVINE_TEMP_REGISTER before continuing
  "  movq  " OLIVINE_TEMP_REGISTER ", %rdx\n"
  "\n"
#endif // OLIVINE_COMMON
  "__afl_forkserver:\n"
  "\n"
  ...
  "  pushq %rdx\n"
#ifdef OLIVINE_COMMON
  // [jfmcoronel] Push Olivine register instead for second push
  "  pushq " OLIVINE_SHM_REGISTER "\n"
#else // OLIVINE_COMMON
  "  pushq %rdx\n"
#endif // OLIVINE_COMMON
  "\n"
  ...
  "\n"
#ifdef OLIVINE_COMMON
  // [jfmcoronel] Pop previously pushed Olivine register
  "  popq " OLIVINE_SHM_REGISTER "\n"
#else // OLIVINE_COMMON
  "  popq %rdx\n"
#endif // OLIVINE_COMMON
  "  popq %rdx\n"
...
#ifdef OLIVINE_COMMON
  "  .comm    __olivine_global_area_ptr, 8, 8\n"
#endif // OLIVINE_COMMON
  "\n"
  ".AFL_SHM_ENV:\n"  // [jfmcoronel] Analog below
  "  .asciz \"" SHM_ENV_VAR "\"\n"  // [jfmcoronel] Analog below
